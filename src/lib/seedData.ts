...
export function seedProspects(): Prospect[] {
  ...
  const hoffman: Prospect = {
    ...
    opportunityType: '401(k) Rollover',
    stage: 'doc-prep',
...
export function sampleProspects(): Prospect[] {
  ...
  return [
    ...
    make({
      ...
      opportunityType: 'Sale of Real Estate',
      stage: 'igo',
      createdDaysAgo: 30,
    ...
    make({
      ...
      opportunityType: 'Bank CD Maturing',
      stage: 'identified',
      createdDaysAgo: 2,
